...
$StartScenarios = @(
    ...
    @{ Id='3'; Title="Access Denied (Execute):"; Op="CreateFile"; Res="ACCESS\ DENIED"; Lookup="ACCESS DENIED"; Path=""; Cause="AppLocker/SRP blocking binary" },
    ...
    @{ Id='15'; Title="Path Not Found (Config):"; Op="CreateFile"; Res="PATH\ NOT\ FOUND"; Lookup="PATH NOT FOUND"; Path=".*\.config"; Cause="Missing configuration" },
    ...
    @{ Id='39'; Title="Cloud Tiering:"; Op="ReadFile"; Res="FILE\ IS\ OFFLINE|STATUS\ FILE\ IS\ OFFLINE"; Lookup="FILE IS OFFLINE"; Path=""; Cause="OneDrive/Azure Files recall needed" },
    ...
    @{ Id='83'; Title="LSA Provider Mod:"; Op=""; Res=""; Lookup=""; Path="Security\\Providers"; Cause="Credential theft/Inject" },
    @{ Id='88'; Title="USB Enum:"; Op=""; Res=""; Lookup=""; Path="Enum\\USB"; Cause="Hardware enumeration" },
    @{ Id='90'; Title="Network Profile:"; Op=""; Res=""; Lookup=""; Path="NetworkList\\Profiles"; Cause="Network location awareness" },
    @{ Id='92'; Title="WPA Key:"; Op=""; Res=""; Lookup=""; Path="Wlansvc\\Parameters"; Cause="WiFi config" },
    @{ Id='93'; Title="Console Config:"; Op=""; Res=""; Lookup=""; Path="Read\ `Console\\Configuration`"; Cause="CMD settings" },
    ...
    @{ Id='197'; Title="Private IP:"; Op=""; Res=""; Lookup=""; Path="10\.x"; Cause="Internal" },
    ...
    @{ Id='204'; Title="Sysvol Latency:"; Op=""; Res=""; Lookup=""; Path="Slow\ read\ `\\\\Domain\\Sysvol`"; Cause="DC overload" },
    ...
    @{ Id='251'; Title="Run Key Persistence:"; Op=""; Res=""; Lookup=""; Path="Write\ `CurrentVersion\\Run`"; Cause="Autostart" },
    @{ Id='259'; Title="Extension Hijack:"; Op=""; Res=""; Lookup=""; Path="Write\ `txtfile\\shell\\open`"; Cause="Assoc hijack" },
    @{ Id='261'; Title="Phantom DLL:"; Op=""; Res=""; Lookup=""; Path="Drop\ `version\.dll`"; Cause="Sideloading" },
    ...
    @{ Id='302'; Title=".NET GAC Load:"; Op=""; Res=""; Lookup=""; Path="Read\ `C:\\Windows\\Assembly`"; Cause="Global lib" },
    ...
    @{ Id='306'; Title=".NET NGEN:"; Op=""; Res=""; Lookup=""; Path="`ngen\.exe`\ activity"; Cause="Optimization" },
    ...
    @{ Id='316'; Title="IIS Config:"; Op=""; Res=""; Lookup=""; Path="Read\ `web\.config`"; Cause="App settings" },
    ...
    @{ Id='328'; Title="Flash OCX:"; Op=""; Res=""; Lookup=""; Path="Load\ `Flash\.ocx`"; Cause="Legacy" },
    ...
    @{ Id='350'; Title="BIOS Info:"; Op=""; Res=""; Lookup=""; Path="Read\ `Hardwaredescription\\System`"; Cause="Firmware" },
    ...
    @{ Id='367'; Title="MFC 42:"; Op=""; Res=""; Lookup=""; Path="Load\ `mfc42\.dll`"; Cause="C++" },
    @{ Id='368'; Title="8.3 Path:"; Op=""; Res=""; Lookup=""; Path="DOCUME\~1"; Cause="Shortname" },
    @{ Id='369'; Title="Hardcoded Drv:"; Op=""; Res=""; Lookup=""; Path="Access\ `D:\\`"; Cause="Missing drive" },
    @{ Id='373'; Title="Legacy Help:"; Op=""; Res=""; Lookup=""; Path="Load\ `winhlp32\.exe`"; Cause=".hlp" },
    ...
    @{ Id='406'; Title="Teams Log:"; Op=""; Res=""; Lookup=""; Path="Write\ `logs\.txt`"; Cause="Diag" },
    @{ Id='407'; Title="Outlook OST:"; Op=""; Res=""; Lookup=""; Path="Read\ `\.ost`\ >\ 100MB"; Cause="Disk IO" },
    ...
    @{ Id='418'; Title="Kubernetes:"; Op=""; Res=""; Lookup=""; Path="Read\ `\.kube`"; Cause="Config" },
    ...
    @{ Id='455'; Title="Events Log:"; Op=""; Res=""; Lookup=""; Path="Write\ `\.evtx`"; Cause="Audit" },
    ...
    @{ Id='495'; Title="Vulkan:"; Op=""; Res=""; Lookup=""; Path="Load\ `vulkan\-1\.dll`"; Cause="Graphics" },
    @{ Id='496'; Title="OpenGL:"; Op=""; Res=""; Lookup=""; Path="Load\ `opengl32\.dll`"; Cause="Graphics" },
    @{ Id='497'; Title="OpenCL:"; Op=""; Res=""; Lookup=""; Path="Load\ `OpenCL\.dll`"; Cause="Compute" },
    ...
    @{ Id='502'; Title="Policy Poll (System):"; Op=""; Res=""; Lookup=""; Path="HKLM\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\System"; Cause="UAC/Logon" },
    ...
    @{ Id='505'; Title="Policy Poll (Edge):"; Op=""; Res=""; Lookup=""; Path="Read\ `HKLM\\Software\\Policies\\Microsoft\\Edge`"; Cause="Browser lock" },
    @{ Id='506'; Title="Policy Poll (Chrome):"; Op=""; Res=""; Lookup=""; Path="Read\ `HKLM\\Software\\Policies\\Google\\Chrome`"; Cause="Browser lock" },
    @{ Id='507'; Title="Policy Poll (Office):"; Op=""; Res=""; Lookup=""; Path="HKCU\\Software\\Policies\\Microsoft\\Office"; Cause="Macro settings" },
    @{ Id='508'; Title="Policy Poll (Defender):"; Op=""; Res=""; Lookup=""; Path="Read\ `HKLM\\Software\\Policies\\Microsoft\\Windows\ Defender`"; Cause="AV settings" },
    @{ Id='509'; Title="Policy Poll (Update):"; Op=""; Res=""; Lookup=""; Path="Read\ `HKLM\\Software\\Policies\\Microsoft\\Windows\\WindowsUpdate`"; Cause="Patching" },
    ...
    @{ Id='515'; Title="Color Poll:"; Op=""; Res=""; Lookup=""; Path="Read\ `HKCU\\Control\ Panel\\Colors`"; Cause="High Contrast" },
    @{ Id='516'; Title="Cursor Poll:"; Op=""; Res=""; Lookup=""; Path="Read\ `HKCU\\Control\ Panel\\Cursors`"; Cause="Accessibility" },
    @{ Id='517'; Title="Sound Poll:"; Op=""; Res=""; Lookup=""; Path="Read\ `HKCU\\AppEvents\\Schemes`"; Cause="Audio feedback" },
    ...
    @{ Id='520'; Title="Printer Poll:"; Op=""; Res=""; Lookup=""; Path="HKCU\\Printers"; Cause="Default printer" },
    ...
    @{ Id='528'; Title="FIPS Poll:"; Op=""; Res=""; Lookup=""; Path="Read\ `HKLM\\SYSTEM\\CurrentControlSet\\Control\\Lsa\\FipsAlgorithmPolicy`"; Cause="Crypto" },
    @{ Id='529'; Title="Winlogon Poll:"; Op=""; Res=""; Lookup=""; Path="HKLM\\SOFTWARE\\Microsoft\\Windows\ NT\\CurrentVersion\\Winlogon"; Cause="Shell" },
    @{ Id='530'; Title="AppInit Poll:"; Op=""; Res=""; Lookup=""; Path="Read\ `HKLM\\SOFTWARE\\Microsoft\\Windows\ NT\\CurrentVersion\\Windows\\AppInit_DLLs`"; Cause="Injection" },
    ...
    @{ Id='536'; Title="Update Crash:"; Op=""; Res=""; Lookup=""; Path="`TiWorker\.exe`\ Exit\ Code\ !=\ 0"; Cause="Install" },
    ...
    @{ Id='543'; Title="Lsass Crash:"; Op=""; Res=""; Lookup=""; Path="`lsass\.exe`\ Exit"; Cause="Reboot" },
    ...
    @{ Id='548'; Title="Svchost RPC:"; Op=""; Res=""; Lookup=""; Path="`svchost\.exe\ \-k\ RpcSs`\ High\ CPU"; Cause="RPC" },
    @{ Id='549'; Title="Svchost Local:"; Op=""; Res=""; Lookup=""; Path="svchost\.exe\ \-k\ LocalService"; Cause="Background" },
    @{ Id='550'; Title="Svchost Net:"; Op=""; Res=""; Lookup=""; Path="`svchost\.exe\ \-k\ NetworkService`\ High\ CPU"; Cause="Network" },
    @{ Id='551'; Title="SysMain Busy:"; Op=""; Res=""; Lookup=""; Path="`svchost\.exe\ \-k\ sysmain`\ Disk\ I"; Cause="Superfetch" },
    ...
    @{ Id='555'; Title="TrustedInstall:"; Op=""; Res=""; Lookup=""; Path="`TrustedInstaller\.exe`\ Disk\ I"; Cause="Update" },
    ...
    @{ Id='559'; Title="WMI Net:"; Op=""; Res=""; Lookup=""; Path="`WmiPrvSE`\ loading\ `wmidex\.dll`"; Cause="Net check" },
    ...
    @{ Id='615'; Title="Excel Addin:"; Op=""; Res=""; Lookup=""; Path="Load\ `\.xla`\ fail"; Cause="Plugin" },
    @{ Id='616'; Title="Outlook OST:"; Op=""; Res=""; Lookup=""; Path="Write\ `\.ost`\ fail"; Cause="Lock" },
    @{ Id='618'; Title="Outlook RPC:"; Op="TCP\ Connect"; Res=""; Lookup=""; Path="outlook\.office365\.com"; Cause="Net" },
    @{ Id='619'; Title="Outlook Autodiscover:"; Op=""; Res=""; Lookup=""; Path="HTTP\ `autodiscover\.xml`\ fail"; Cause="Config" },
    @{ Id='620'; Title="Outlook Addin:"; Op=""; Res=""; Lookup=""; Path="outlvba\.dll"; Cause="Macro" },
    @{ Id='621'; Title="Access Lock:"; Op=""; Res=""; Lookup=""; Path="Write\ `\.ldb`\ fail"; Cause="Record lock" },
    ...
    @{ Id='624'; Title="OneNote Cache:"; Op=""; Res=""; Lookup=""; Path="Write\ `\.bin`\ fail"; Cause="Sync" },
    @{ Id='625'; Title="Office Update:"; Op=""; Res=""; Lookup=""; Path="`OfficeClickToRun\.exe`\ activity"; Cause="Update" },
    @{ Id='626'; Title="Office License:"; Op=""; Res=""; Lookup=""; Path="`OSPP\.VBS`\ execution"; Cause="Activation" },
    ...
    @{ Id='654'; Title="NetBIOS:"; Op=""; Res=""; Lookup=""; Path="`netbt\.sys`\ activity"; Cause="Legacy" },
    @{ Id='655'; Title="AFD Driver:"; Op=""; Res=""; Lookup=""; Path="`afd\.sys`\ activity"; Cause="Sock" },
    ...
    @{ Id='659'; Title="USB Port:"; Op=""; Res=""; Lookup=""; Path="`usbport\.sys`\ activity"; Cause="Bus" },
    @{ Id='660'; Title="USB Hub:"; Op=""; Res=""; Lookup=""; Path="`usbhub\.sys`\ activity"; Cause="Bus" },
    ...
    @{ Id='663'; Title="Kbd Class:"; Op=""; Res=""; Lookup=""; Path="`kbdclass\.sys`\ activity"; Cause="Input" },
    ...
    @{ Id='666'; Title="AMD:"; Op=""; Res=""; Lookup=""; Path="`atikmdag\.sys`\ activity"; Cause="GPU" },
    ...
    @{ Id='713'; Title="PS Profile:"; Op=""; Res=""; Lookup=""; Path="Read\ `Microsoft\.PowerShell_profile\.ps1`"; Cause="Config" },
    @{ Id='714'; Title="PS History:"; Op=""; Res=""; Lookup=""; Path="Read\ `ConsoleHost_history\.txt`"; Cause="Log" },
    @{ Id='716'; Title="PS Transcript:"; Op=""; Res=""; Lookup=""; Path="Write\ `Transcript\.txt`"; Cause="Log" },
    @{ Id='717'; Title="PS Gallery:"; Op=""; Res=""; Lookup=""; Path="Connect\ `powershellgallery\.com`"; Cause="Download" },
    @{ Id='721'; Title="VBS Engine:"; Op=""; Res=""; Lookup=""; Path="Load\ `vbscript\.dll`"; Cause="Legacy" },
    ...
    @{ Id='727'; Title="Python Script:"; Op=""; Res=""; Lookup=""; Path="Exec\ `\.py`"; Cause="Dev" },
    ...
    @{ Id='734'; Title="ShellBag:"; Op=""; Res=""; Lookup=""; Path="Reg\ Write\ `Shell\\Bags`"; Cause="Folder view" },
    @{ Id='737'; Title="Amcache:"; Op=""; Res=""; Lookup=""; Path="Write\ `Amcache\.hve`"; Cause="Inventory" },
    ...
    @{ Id='754'; Title="WindowsUpdate:"; Op=""; Res=""; Lookup=""; Path="Write\ `WindowsUpdate\.log`"; Cause="Patch" },
    ...
    @{ Id='765'; Title="Panther:"; Op=""; Res=""; Lookup=""; Path="\\Panther"; Cause="Setup" },
    ...
    @{ Id='865'; Title="SQL Shared:"; Op=""; Res=""; Lookup=""; Path="Load\ `sqlmin\.dll`"; Cause="Engine" },
    ...
    @{ Id='871'; Title="Git Config:"; Op=""; Res=""; Lookup=""; Path="Read\ `\.gitconfig`"; Cause="Settings" },
    ...
    @{ Id='921'; Title="VSS Create:"; Op=""; Res=""; Lookup=""; Path="`vssvc\.exe`\ start"; Cause="Snapshot" },
    ...
    @{ Id='934'; Title="Print Net:"; Op=""; Res=""; Lookup=""; Path="Load\ `tcpmon\.dll`"; Cause="IP" },
    ...
    @{ Id='952'; Title="Revit:"; Op=""; Res=""; Lookup=""; Path="`revit\.exe`\ crash"; Cause="BIM" },
    ...
    @{ Id='968'; Title="Mellanox:"; Op=""; Res=""; Lookup=""; Path="Load\ `mlx.*sys`"; Cause="NIC" },
    ...
    @{ Id='1012'; Title="WerFault Suppression:"; Op=""; Res=""; Lookup=""; Path="`WerFault\.exe`\ starts\ but\ exits\ immediately\ with\ no\ UI"; Cause="Headless mode crash" },
    ...
    @{ Id='1023'; Title="AccName Missing:"; Op=""; Res=""; Lookup=""; Path="IAccessible::get_accName"; Cause="Unlabeled button" },
    ...
    @{ Id='1032'; Title="Mirror Driver Fail:"; Op=""; Res=""; Lookup=""; Path="jfwvid\.dll"; Cause="Video hook broken" },
    ...
    @{ Id='1038'; Title="Pattern Not Supported:"; Op=""; Res=""; Lookup=""; Path="`IUIAutomation::GetPattern`\ returns\ null"; Cause="Control broken" },
    ...
    @{ Id='1058'; Title="Tablet Service:"; Op=""; Res=""; Lookup=""; Path="`TabTip\.exe`\ crash"; Cause="Touch keyboard" },
    ...
    @{ Id='1101'; Title="USB Redirection:"; Op=""; Res=""; Lookup=""; Path="`tsusbhub\.sys`\ fail"; Cause="Scanner doesn't map" },
    @{ Id='1102'; Title="SmartCard Redir:"; Op=""; Res=""; Lookup=""; Path="winscard\.dll"; Cause="Middleware" },
    @{ Id='1104'; Title="Printer Mapping:"; Op=""; Res=""; Lookup=""; Path="`C:\\Windows\\System32\\spool\\servers`\ access"; Cause="Driver pull" },
    ...
    @{ Id='1123'; Title="Render Filter:"; Op=""; Res=""; Lookup=""; Path="`mxdwdrv\.dll`\ crash"; Cause="XPS convert" },
    ...
    @{ Id='1'; Title="`WM_GETOBJECT` Timeout:"; Op=""; Res="TIMEOUT"; Lookup="TIMEOUT"; Path=""; Cause="freezes the screen reader" },
    @{ Id='2'; Title="`OBJID_CLIENT` Failure:"; Op=""; Res=""; Lookup=""; Path="App\ returning\ `E_FAIL`\ when\ queried\ for\ the\ client\ area\ object\ ID\."; Cause="" },
    @{ Id='5'; Title="Duplicate `accID` Generation:"; Op=""; Res=""; Lookup=""; Path="Two\ distinct\ UI\ elements\ reporting\ the\ same\ Accessibility\ ID\."; Cause="" },
    @{ Id='7'; Title="`accState` Stagnation:"; Op=""; Res=""; Lookup=""; Path="A\ checkbox\ is\ visually\ checked,\ but\ `get_accState`\ still\ reports\ `STATE_SYSTEM_UNCHECKED`\."; Cause="" },
    @{ Id='9'; Title="Event Flood (`EVENT_OBJECT_LOCATIONCHANGE`):"; Op=""; Res=""; Lookup=""; Path="App\ firing\ 100\ location\ change\ events\ per\ second\ for\ a\ static\ window\."; Cause="" },
    @{ Id='15'; Title="Tree Walker Loop:"; Op=""; Res=""; Lookup=""; Path="`TreeWalker`\ gets\ stuck\ in\ a\ loop\ navigating\ `NextSibling`\."; Cause="" },
    @{ Id='16'; Title="Disconnected Provider:"; Op=""; Res=""; Lookup=""; Path="The\ underlying\ HWND\ is\ destroyed,\ but\ the\ UIA\ provider\ throws\ exceptions\ instead\ of\ failing\ gracefully\."; Cause="" },
    @{ Id='17'; Title="Unsupported Pattern Exception:"; Op=""; Res=""; Lookup=""; Path="Client\ asks\ for\ `ScrollPattern`,\ app\ throws\ exception\ instead\ of\ returning\ `null`\."; Cause="" },
    @{ Id='22'; Title="`Narrator.exe` Hook Failure:"; Op=""; Res="ACCESS\ DENIED"; Lookup="ACCESS DENIED"; Path="NarratorHook\.dll"; Cause="" },
    @{ Id='26'; Title="Focus Loss on Modal Close:"; Op=""; Res=""; Lookup=""; Path="Closing\ a\ popup\ dialog\ sends\ focus\ to\ `NULL`\ or\ the\ Desktop\ instead\ of\ the\ parent\ app\."; Cause="" },
    @{ Id='28'; Title="Touch Interaction API Fail:"; Op=""; Res=""; Lookup=""; Path="Touch\ screen\ gestures\ fail\ to\ translate\ to\ accessibility\ commands\."; Cause="" },
    @{ Id='29'; Title="Synthetic Click Rejection:"; Op=""; Res=""; Lookup=""; Path="App\ ignores\ `InvokePattern\.Invoke"; Cause="" },
    @{ Id='31'; Title="`Chrome_RenderWidgetHostHWND` Lag:"; Op=""; Res=""; Lookup=""; Path="Chrome\ accessibility\ tree\ update\ taking\ >1s\."; Cause="" },
    @{ Id='32'; Title="`ISimpleDOM` Node Access Denied:"; Op=""; Res=""; Lookup=""; Path="Third\-party\ AT\ failing\ to\ access\ Firefox\ DOM\ nodes\."; Cause="" },
    @{ Id='33'; Title="IFrame Security Boundary:"; Op=""; Res=""; Lookup=""; Path="Screen\ reader\ failing\ to\ cross\ into\ a\ cross\-origin\ IFrame\."; Cause="" },
    @{ Id='36'; Title="PDF Tagging Read Error:"; Op=""; Res=""; Lookup=""; Path="Acrobat\ Reader\ failing\ to\ parse\ the\ structure\ tree\ of\ a\ PDF\."; Cause="" },
    @{ Id='37'; Title="Shadow DOM Boundary:"; Op=""; Res=""; Lookup=""; Path="AT\ failing\ to\ penetrate\ Shadow\ DOM\ V1\ boundaries\."; Cause="" },
    @{ Id='38'; Title="High Contrast Mode Detection:"; Op=""; Res=""; Lookup=""; Path="Web\ content\ failing\ to\ detect\ `HighContrast`\ media\ query\."; Cause="" },
    @{ Id='39'; Title="Zoom Level Scaling:"; Op=""; Res=""; Lookup=""; Path="Text\ scaling\ >200%\ causes\ layout\ thrashing"; Cause="performance spike" },
    @{ Id='41'; Title="Java Access Bridge (JAB) Load Fail:"; Op=""; Res=""; Lookup=""; Path="WindowsAccessBridge\-64\.dll"; Cause="" },
    @{ Id='42'; Title="JAB Version Mismatch:"; Op=""; Res=""; Lookup=""; Path="JVM\ loading\ 32\-bit\ bridge\ in\ a\ 64\-bit\ OS\ environment\."; Cause="" },
    @{ Id='44'; Title="Silverlight Automation Peer:"; Op=""; Res=""; Lookup=""; Path="Missing\ automation\ peer\ for\ Silverlight\ controls\."; Cause="" },
    @{ Id='45'; Title="Qt Accessibility Plugin:"; Op=""; Res=""; Lookup=""; Path="Qt\ app\ running\ without\ the\ `qtaccessiblewidgets`\ plugin\."; Cause="" },
    @{ Id='47'; Title="Terminal Emulator HLLAPI:"; Op=""; Res=""; Lookup=""; Path="Screen\ reader\ failing\ to\ hook\ HLLAPI\ for\ mainframe\ text\ extraction\."; Cause="" },
    @{ Id='48'; Title="Citrix Virtual Channel Block:"; Op=""; Res=""; Lookup=""; Path="Accessibility\ data\ failing\ to\ traverse\ the\ ICA\ channel\."; Cause="" },
    @{ Id='49'; Title="RDP Audio Redirection:"; Op=""; Res=""; Lookup=""; Path="Screen\ reader\ audio\ failing\ to\ redirect\ to\ the\ client\."; Cause="" },
    @{ Id='50'; Title="SAP GUI Scripting Disabled:"; Op=""; Res=""; Lookup=""; Path="SAP\ client\ rejecting\ automation\ requests\ due\ to\ security\ settings\."; Cause="" },
    @{ Id='52'; Title="HID Device Exclusive Lock:"; Op=""; Res=""; Lookup=""; Path="One\ screen\ reader\ locking\ the\ Braille\ HID\ device,\ preventing\ another\ from\ using\ it\."; Cause="" },
    @{ Id='53'; Title="Switch Control Input Lag:"; Op=""; Res=""; Lookup=""; Path="Input\ lag\ >200ms\ for\ adaptive\ switch\ devices\."; Cause="" },
    @{ Id='54'; Title="Eye Tracker Calibration File:"; Op=""; Res="ACCESS\ DENIED"; Lookup="ACCESS DENIED"; Path=""; Cause="" },
    @{ Id='55'; Title="Magnifier Driver Overlay:"; Op=""; Res=""; Lookup=""; Path="Magnify\.exe"; Cause="" },
    @{ Id='57'; Title="Tablet Input Service Hang:"; Op=""; Res=""; Lookup=""; Path="TabTip\.exe"; Cause="" },
    @{ Id='58'; Title="Driver Signature Enforcement:"; Op=""; Res=""; Lookup=""; Path="Custom\ AT\ driver\ blocked\ from\ loading\."; Cause="" },
    @{ Id='59'; Title="USB Power Management:"; Op=""; Res=""; Lookup=""; Path="AT\ device\ disconnects\ because\ Windows\ put\ the\ USB\ hub\ to\ sleep\."; Cause="" },
    @{ Id='60'; Title="Bluetooth MIDI Latency:"; Op=""; Res=""; Lookup=""; Path="Delay\ in\ MIDI\ signals\ for\ musical\ AT\ devices\."; Cause="" },
    @{ Id='63'; Title="Theme API Crash:"; Op=""; Res=""; Lookup=""; Path="uxtheme\.dll"; Cause="" },
    ...
    @{ Id='69'; Title="Transparency Disable:"; Op=""; Res=""; Lookup=""; Path="App\ ignoring\ the\ "Transparency\ Effects:\ Off"\ system\ setting\."; Cause="" },
    ...
    @{ Id='76'; Title="Audio Buffer Underrun:"; Op=""; Res=""; Lookup=""; Path="CPU\ spike\ causing\ speech\ recognition\ to\ drop\ audio\ frames\."; Cause="" },
    @{ Id='77'; Title="Command Confusion:"; Op=""; Res=""; Lookup=""; Path="App\ defines\ custom\ shortcuts\ that\ conflict\ with\ global\ Dictation\ commands\."; Cause="" },
    ...
    @{ Id='81'; Title="Roaming Settings Latency:"; Op=""; Res=""; Lookup=""; Path="JAWS\ taking\ 2\ minutes\ to\ load\ roaming\ config\ from\ network\."; Cause="" },
    @{ Id='83'; Title="Ease of Access Registry Reset:"; Op=""; Res=""; Lookup=""; Path="HKCU\\Control\ Panel\\Accessibility"; Cause="" },
    ...
    @{ Id='88'; Title="License Manager Conflict:"; Op=""; Res=""; Lookup=""; Path="ZoomText\ license\ manager\ service\ unreachable\."; Cause="" },
    ...
    @{ Id='90'; Title="Inter-Process Communication (IPC):"; Op=""; Res=""; Lookup=""; Path="Named\ pipe\ connection\ failure\ between\ AT\ and\ its\ helper\ process\."; Cause="" },
    @{ Id='91'; Title="Custom Drawing without `IAccessible`:"; Op=""; Res=""; Lookup=""; Path="DirectX\ but\ implements\ 0\ accessibility\."; Cause="" },
    @{ Id='93'; Title="Keyboard Trap:"; Op=""; Res=""; Lookup=""; Path="User\ can\ Tab\ .*into.*\ a\ control\ but\ cannot\ Tab\ .*out.*"; Cause="requires mouse to exit" },
