...
$StartScenarios = @(
    ...
    @{ Id='1478'; Title="Quick Access FTP Freeze"; Op="CreateFile"; Res=""; Lookup=""; Path="(?i)(ftp:|\\\\ftp)"; Cause="Explorer hanging on FTP site in Recent Files." },
    @{ Id='1482'; Title="Time Zone Auto Fail"; Op="RegSetValue"; Res=""; Lookup=""; Path="(?i)ActiveTimeBias"; Cause="Time Zone update service fighting with location." },
    @{ Id='1499'; Title="OOBE Complete Flag"; Op="RegQueryValue"; Res=""; Lookup=""; Path="(?i)OOBEComplete"; Cause="Search Indexer waiting for OOBE to finish." },
